...
<head>
    ...
    <link rel="stylesheet" href="adminsideupdates.css">
...
<body>
    ...
    <div class="admin-container">
        <!-- Sidebar -->
        <aside class="sidebar">
            <h3 class="am-mmdash">4Ps Super Admin</h3>
            <nav>
                <ul>
                    <li><a href="superadmin.php" class="">Dashboard</a></li>
                    <li><a href="adminsidemm.php" class="">Manage Members</a></li>
                    <li><a href="adminsidemeeting.php">Meeting</a></li>
                    <li><a href="adminsideupdates.php" class="active">FDS Updates</a></li>
